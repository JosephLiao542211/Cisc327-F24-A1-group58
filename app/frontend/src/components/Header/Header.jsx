...
const Header = () => {
    ...
    return (
        <header className="header">
            ...
            <img src="logo.png" alt="Logo" style={{ marginBottom: '0px', height: '60px', cursor: 'pointer' }} onClick={() => window.location.href = '/'} />
            ...
            <nav className="nav">
                ...
                {userData ? (
                    ...
                    <button className="nav-login-button" onClick={navigateTohome}>
                        <img src="profile-icon.png" alt="Profile Icon" style={{ height: '50px', marginRight: '10px' }} />
                        {userData.firstName}
                    </button>
                ) : (
                    // If userData does not exist, show the login/signup button
                    <button className="nav-login-button" onClick={navigateToSignup}>
                        Login/Signup
                    </button>
                )}
            </nav>
